...
const DataLayer = require('./companyAddOns.datalayer')
const TAG = '/api/v1/companyAddOns/companyAddOns.controller.js'
...
exports.index = function (req, res) {
  DataLayer.findAllRecords()
    ...
    .catch(err => {
      const message = err || 'Failed to find company addOns'
...
exports.create = function (req, res) {
  DataLayer.createOneRecord(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to create company addOn'
...
exports.update = function (req, res) {
  DataLayer.updateRecords(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to update company addOns'
...
exports.delete = function (req, res) {
  DataLayer.deleteRecords(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to delete company addOns'
