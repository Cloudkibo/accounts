...
*/
const LogicLayer = require('./companyAddOns.logiclayer')
const MongoInterface = require('./interface_mongo')
const logger = require('../../../components/logger')
const TAG = '/api/v1/companyAddOns/companyAddOns.datalayer.js'

const util = require('util')

exports.findAllRecords = () => {
...
exports.findRecordsUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
