...
*/
const LogicLayer = require('./contactLists.logiclayer')
const MongoInterface = require('./interface_mongo')

exports.createContactList = (body) => {
...
exports.updateContactList = (body) => {
  if (body.purpose) {
...
exports.findContactListsUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
...
exports.deleteContactList = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
