...
*/
const LogicLayer = require('./custom_field_subscriber.logiclayer')
const MongoInterface = require('./interface_mongo')
const logger = require('../../../components/logger')
const TAG = '/api/v1/kiboengage/custom_field_subscriber/custom_field_subscriber.datalayer.js'

const util = require('util')

exports.findAllCustomFieldSubscriberObjects = () => {
  return MongoInterface.find()
}

exports.createOneCustomFieldSubscriberObject = (body) => {
...
exports.updateCustomFieldSubscriber = (body) => {
  if (body.purpose) {
...
exports.findCustomFieldubscriberUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
...
exports.deleteCustomFieldSubscriber = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
